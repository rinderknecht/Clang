...
namespace Cortus.TestSuite
{
    class Arrays
    {
        ...
        {
            Test(test_10_create() == 10, "test_10_create");
            Test(test_0_unset_value() == 0, "test_0_unset_value");
            Test(test_3_set_value() == 3, "test_3_set_value");
            Test(test_0_char_array_1() == 0, "test_0_char_array_1");
            Test(test_0_char_array_2() == 0, "test_0_char_array_2");
            Test(test_0_char_array_3() == 0, "test_0_char_array_3");
            Test(test_0_byte_array() == 0, "test_0_byte_array");
            Test(test_0_set_after_shift() == 0, "test_0_set_after_shift");
            Test(test_0_newarr_emulation() == 0, "test_0_newarr_emulation");
            Test(test_1_bit_index() == 1, "test_1_bit_index");
            Test(test_2_regalloc() == 2, "test_2_regalloc");
            Test(test_0_stelemref_1() == 0, "test_0_stelemref_1");
            Test(test_0_stelemref_2() == 0, "test_0_stelemref_2");
            Test(test_0_stelemref_3() == 0, "test_0_stelemref_3");
            Test(test_0_stelemref_4() == 0, "test_0_stelemref_4");
            Test(test_0_arrays() == 0, "test_0_arrays");

            Test(test_0_multi_dimension_arrays() == 0, "test_0_multi_dimension_arrays");
            Test(test_0_bug_71454() == 0, "test_0_bug_71454");

            Test(test_0_interface_array_cast() == 0, "test_0_interface_array_cast");
            Test(test_0_regress_74549() == 0, "test_0_regress_74549");
            Test(test_0_regress_75832() == 0, "test_0_regress_75832");
            Test(test_0_stelem_ref_null_opt() == 0, "test_0_stelem_ref_null_opt");

            Test(test_0_invalid_new_array_size() == 0, "test_0_invalid_new_array_size");
            Test(test_0_invalid_new_multi_dym_array_size() == 0, "test_0_invalid_new_multi_dym_array_size");
